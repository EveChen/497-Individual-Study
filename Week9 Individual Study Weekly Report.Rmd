...
```{r}
system.time({
  md_rf <- randomForest(y=train_dat$y, x = train_dat[, -ncol(train_dat)],
...
```{r}
varImpPlot(md_rf,type=2)
``` 

***

###C. Comparisons
####(1.) Compare with different packages

####(2.) Compare random forest with logistic model 
